...
idx = ['122_' in file_name for file_name in f_names]
...
split_algo_ocr = '/home/ferhdzschz/sandbox/projects/datavio_files/lime/ocr_split/'
img_dir = '/home/ferhdzschz/sandbox/projects/datavio_files/lime/correct_imgs/'
f_names = os.listdir(img_dir)
f_names.sort()
...
for f in f_names:
    ...
    h_limits_list = [500, 600, 800]
    texto_completo = split_algo(img_dir + f, h_limits_list)
    with open('/home/ferhdzschz/sandbox/projects/datavio_files/lime/ocr_split/{}.tsv'.format(file_str), 'wt') as file:
