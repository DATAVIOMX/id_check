...
URL_TXT = "http://www.dataviomx.com/api/v1/id-check/text"  # Falta la base de l$
URL_IMG = "http://www.dataviomx.com/api/v1/id-check/images"

#URL_TXT = "http://localhost:5000/api/v1/id-check/text"  # Falta la base de la $
#URL_IMG = "http://localhost:5000/api/v1/id-check/images"

#URL_TXT = "http://localhost:8000/api/v1/id-check/text"  # Falta la base de la $
